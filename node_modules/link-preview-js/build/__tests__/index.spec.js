...
describe(`#getLinkPreview()`, () => {
    it(`should extract link info from just URL`, () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const linkInfo = yield getLinkPreview(`https://www.youtube.com/watch?v=wuClZjOdT30`, {
    ...
    it("returns charset of website", () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const linkInfo = yield getLinkPreview(`https://www.pravda.com.ua`);
    ...
    xit("should extract author from news article", () => __awaiter(void 0, void 0, void 0, function* () {
        const linkInfo = yield getLinkPreview(`https://www.usatoday.com/story/special/contributor-content/2025/10/15/why-chaos-engineering-is-more-important-than-ever-in-the-ai-era/86712877007/`);
    ...
    it(`should extract link info from a URL with a newline`, () => __awaiter(void 0, void 0, void 0, function* () {
        const linkInfo = yield getLinkPreview(`
    ...
    it(`should extract link info from just text with a URL`, () => __awaiter(void 0, void 0, void 0, function* () {
        const linkInfo = yield getLinkPreview(`This is some text blah blah https://www.youtube.com/watch?v=wuClZjOdT30 and more text`, { headers: { "Accept-Language": `en-US` } });
        expect(linkInfo.url).toEqual(`https://www.youtube.com/watch?v=wuClZjOdT30`);
        expect(linkInfo.title).toEqual(`Geography Now! Germany`);
        expect(linkInfo.siteName).toEqual(`YouTube`);
        expect(linkInfo.description).toBeTruthy();
    ...
    it(`should handle audio urls`, () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const linkInfo = yield getLinkPreview(`https://ondemand.npr.org/anon.npr-mp3/npr/atc/2007/12/20071231_atc_13.mp3`);
    ...
    it(`should handle video urls`, () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const linkInfo = yield getLinkPreview(`https://www.w3schools.com/html/mov_bbb.mp4`);
    ...
    it(`should handle image urls`, () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        const linkInfo = yield getLinkPreview(`https://media.npr.org/assets/img/2018/04/27/gettyimages-656523922nunes-4bb9a194ab2986834622983bb2f8fe57728a9e5f-s1100-c15.jpg`);
    ...
    it(`should handle unknown content type urls`, () => __awaiter(void 0, void 0, void 0, function* () {
        const linkInfo = yield getLinkPreview(`https://mjml.io/try-it-live`);
    ...
    it(`no link in text should fail gracefully`, () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(getLinkPreview(`no link`)).rejects.toThrowErrorMatchingSnapshot();
    }));
    it(`should handle malformed urls gracefully`, () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(getLinkPreview(`this is a malformed link: ahttps://www.youtube.com/watch?v=wuClZjOdT30`)).rejects.toThrowErrorMatchingSnapshot();
    }));
    it(`should block .internal hostnames`, () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(getLinkPreview(`http://metadata.google.internal/computeMetadata/v1/instance/service-accounts/default/token`)).rejects.toThrowErrorMatchingSnapshot();
    }));
    it(`should block .local hostnames`, () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(getLinkPreview(`http://printer.local/status`)).rejects.toThrowErrorMatchingSnapshot();
    }));
    it(`should block nip.io wildcard hostnames`, () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(getLinkPreview(`http://169.254.169.254.nip.io/latest/meta-data/iam/security-credentials/`)).rejects.toThrowErrorMatchingSnapshot();
    }));
    it(`should block sslip.io wildcard hostnames`, () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(getLinkPreview(`http://127.0.0.1.sslip.io/`)).rejects.toThrowErrorMatchingSnapshot();
    }));
    it(`should handle empty strings gracefully`, () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(getLinkPreview(``)).rejects.toThrowErrorMatchingSnapshot();
    }));
    ...
    it("should timeout (default 3s) with infinite loading link", () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield getLinkPreview(`https://www.gamestop.com/video-games/pc-gaming/components/cooling/products/hyper-212-rgb-black-edition-fan/185243.html?gclid=Cj0KCQjwraqHBhDsARIsAKuGZeECDlqkF2cxpcuS0xRxQmrv5BxFawWS_B51kiqehPf64_KlO0oyunsaAhn5EALw_wcB&gclsrc=aw.ds`);
        }
        catch (e) {
    ...
    it(`should handle followRedirects option is error`, () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield getLinkPreview(`http://google.com/`, { followRedirects: `error` });
        }
        catch (e) {
    ...
    it(`should handle followRedirects option is manual but handleRedirects was not provided`, () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            yield getLinkPreview(`http://google.com/`, { followRedirects: `manual` });
        }
        catch (e) {
    ...
    it(`should handle followRedirects option is manual with handleRedirects function`, () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield getLinkPreview(`http://google.com/`, {
    ...
    it("should handle override response body using onResponse option", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const res = yield getLinkPreview(`https://www.example.com/`, {
    ...
    it("should handle video tags without type or secure_url tags", () => __awaiter(void 0, void 0, void 0, function* () {
        const res = yield getLinkPreview(`https://newpathtitle.com/falling-markets-how-to-stop-buyer-from-getting-out/`, { followRedirects: `follow` });
...
describe(`#getPreviewFromContent`, () => {
    it(`Basic parsing`, () => __awaiter(void 0, void 0, void 0, function* () {
        const linkInfo = yield getPreviewFromContent(prefetchedResponse);
        expect(linkInfo.url).toEqual(`https://www.youtube.com/watch?v=wuClZjOdT30`);
        expect(linkInfo.siteName).toEqual(`YouTube`);
        expect(linkInfo.title).toEqual(`Geography Now! Germany`);
        expect(linkInfo.description).toBeTruthy();
